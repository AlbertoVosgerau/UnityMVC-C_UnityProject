...
namespace ModuleNamespace
{
    ...
    public partial class ModuleNameView : View
    {
        private ModuleNameController Controller => _controller;
        private ModuleNameController _controller;
        public /*NEW*/ ModuleNameControllerEvents Events => _controller.Events;
        public /*NEW*/ ModuleNameViewModel Data => _data;
        private readonly ModuleNameViewModel _data = new ModuleNameViewModel();
        ...
        {
            _controller = MVCApplication.Controllers.Get<ModuleNameController>();
        }
