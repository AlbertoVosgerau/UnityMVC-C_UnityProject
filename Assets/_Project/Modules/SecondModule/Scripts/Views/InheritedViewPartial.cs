...
namespace SecondNamespace
{
    ...
    public partial class InheritedView : SecondModuleView
    {
        private SecondModuleController Controller => _controller;
        private SecondModuleController _controller;
        public new SecondModuleControllerEvents Events => _controller.Events;
        ...
        {
            _controller = MVCApplication.Controllers.Get<SecondModuleController>();
        }
