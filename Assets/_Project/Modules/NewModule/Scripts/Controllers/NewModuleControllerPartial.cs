...
namespace NewNamespace
{
    ...
    public partial class NewModuleController : Controller
    {
        private NewModuleView View => _view;
        private NewModuleView _view;
        public /*NEW*/ NewModuleControllerEvents Events => _events;
        private readonly NewModuleControllerEvents _events = new NewModuleControllerEvents();
