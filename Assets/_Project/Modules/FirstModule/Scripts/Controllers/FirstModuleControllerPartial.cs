...
namespace FuirsNamespace
{
    ...
    public partial class FirstModuleController : Controller
    {
        private FirstModuleView View => _view;
        private FirstModuleView _view;
        public  FirstModuleControllerEvents Events => _events;
        private readonly FirstModuleControllerEvents _events = new FirstModuleControllerEvents();
