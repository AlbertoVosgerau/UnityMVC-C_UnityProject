...
namespace FuirsNamespace
{
    ...
    public partial class InheritedView : FirstModuleView
    {
        private FirstModuleController Controller => _controller;
        private FirstModuleController _controller;
        public new FirstModuleControllerEvents Events => _controller.Events;
        public new InheritedViewModel Data => _data;
        private readonly InheritedViewModel _data = new InheritedViewModel();
        ...
        {
            _controller = MVCApplication.Controllers.Get<FirstModuleController>();
        }
