...
namespace FuirsNamespace
{
    ...
    public partial class FirstModuleView : View
    {
        private FirstModuleController Controller => _controller;
        private FirstModuleController _controller;
        public  FirstModuleControllerEvents Events => _controller.Events;
        public  FirstModuleViewModel Data => _data;
        private readonly FirstModuleViewModel _data = new FirstModuleViewModel();
