...
namespace ThirdNamespace
{
    ...
    public partial class ThirdModuleView : View
    {
        private ThirdModuleController Controller => _controller;
        private ThirdModuleController _controller;
        public  ThirdModuleControllerEvents Events => _controller.Events;
        public  ThirdModuleViewModel Data => _data;
        private readonly ThirdModuleViewModel _data = new ThirdModuleViewModel();
        ...
        {
            _controller = MVCApplication.Controllers.Get<ThirdModuleController>();
        }
