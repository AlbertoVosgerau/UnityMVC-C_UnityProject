...
namespace ThirdNamespace
{
    ...
    public partial class ThirdModuleController : Controller
    {
        private ThirdModuleView View => _view;
        private ThirdModuleView _view;
        public  ThirdModuleControllerEvents Events => _events;
        private readonly ThirdModuleControllerEvents _events = new ThirdModuleControllerEvents();
        ...
        public override bool IsActive()
        {
            ...
            if (viewExists)
            {
                Debug.LogWarning($"View {typeof(ThirdModuleView).Name} does not exist");
            }
            if (!isActive)
            {
