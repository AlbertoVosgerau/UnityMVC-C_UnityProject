...
namespace dasdasdsda
{
    ...
    public partial class asdasdController : Controller
    {
        private asdasdView View => _view;
        private asdasdView _view;
        public  asdasdControllerEvents Events => _events;
        private readonly asdasdControllerEvents _events = new asdasdControllerEvents();
        ...
        public override bool IsActive()
        {
            ...
            if (viewExists)
            {
                Debug.LogWarning($"View {typeof(asdasdView).Name} does not exist");
            }
            if (!isActive)
            {
