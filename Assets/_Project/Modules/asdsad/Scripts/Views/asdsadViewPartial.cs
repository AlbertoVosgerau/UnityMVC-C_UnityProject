...
namespace asdsadasd
{
    ...
    public partial class asdsadView : View
    {
        private asdsadController Controller => _controller;
        private asdsadController _controller;
        public  asdsadControllerEvents Events => _controller.Events;
        public  asdsadViewModel Data => _data;
        private readonly asdsadViewModel _data = new asdsadViewModel();
        ...
        {
            _controller = MVCApplication.Controllers.Get<asdsadController>();
        }
